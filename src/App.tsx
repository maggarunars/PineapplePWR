 ...
 {/*Here we're using a map function that itirates over the lights array. The "height" prop on the lights component is set to a random value based on the window's heights. */}      
      ...
      <TreeContainer>
        ...
        <TreeSection>
          ...
          <div style={{cursor: 'grab'}} onClick={() => handleOpenWish()}><Player src="https://lottie.host/a8e1c538-f06f-498d-8e63-9ea299ebf4e1/dugKs7XOGt.json" id="8" style={{transform: 'translate(5px, 3px)'}} loop autoplay></Player></div>
